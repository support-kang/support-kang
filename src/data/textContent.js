export const sectionIndex = [
  ...
  { id: 'project-records', number: '02', label: 'Project Records' },
  { id: 'technical-range', number: '03', label: 'Technical Range' },
  { id: 'engineering-notes', number: '04', label: 'Engineering Notes' },
...
export const sectionCopy = {
  projectRecords: {
    ...
    body: '기간·역할·환경·결정 단위로 기록한 작업 명세서.',
  },
  technicalRange: {
    number: '03',
